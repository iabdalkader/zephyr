...
function(to_yaml in_json level yaml mode)
  ...
  if(mode STREQUAL "DIRECT")
    # Direct output mode, no genexes: no special handling
    set(expand_lists TRUE)
    set(escape_quotes TRUE)
    set(comment_genexes FALSE)
  elseif(mode STREQUAL "DIRECT_GENEX")
    # Direct output mode, genexes enabled: comment them
    set(expand_lists TRUE)
    set(escape_quotes TRUE)
    set(comment_genexes TRUE)
  elseif(mode STREQUAL "TEMP_GENEX")
    # Temporary output mode, genexes enabled
    set(expand_lists FALSE)
    set(escape_quotes FALSE) # will be done by yaml-filter.cmake
    set(comment_genexes FALSE)
  elseif(mode STREQUAL "FINAL_GENEX")
    # Final output, genexes enabled
    set(expand_lists TRUE)
    set(escape_quotes FALSE) # already done by yaml-filter.cmake
    set(comment_genexes TRUE) # not really useful
  endif()
